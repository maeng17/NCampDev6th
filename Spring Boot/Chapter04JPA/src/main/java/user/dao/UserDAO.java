...
public interface UserDAO extends JpaRepository<UserDTO, String> {
	...
	public List<UserDTO> getUserSearhName(String value);
	
	@Query("select dto from UserDTO dto where dto.id like concat('%', ?1, '%')")
	public List<UserDTO> getUserSearhId(String value);
	*/
	
	@Query("select dto from UserDTO dto where dto.name like concat('%', :value, '%')")
	public List<UserDTO> getUserSearhName(@Param("value") String value);
	
	@Query("select dto from UserDTO dto where dto.id like concat('%', :value, '%')")
	public List<UserDTO> getUserSearhId(@Param("value") String value);
