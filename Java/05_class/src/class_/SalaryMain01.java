...
public class SalaryMain01 {
	

	public static void main(String[] args) {		
		SalaryDTO01[] ar = new SalaryDTO01[3];
		ar[0] = new SalaryDTO01();
		ar[1] = new SalaryDTO01();
		ar[2] = new SalaryDTO01();
		...
		for(SalaryDTO01 data : ar) {
			...
			System.out.println(data.getName() + "\t" 
					...
					+ df.format(data.getRate()) + "\t\t"
							+ df.format(data.getTax()) + "\t\t"//String.format("%.2f", aa,getAvg()
