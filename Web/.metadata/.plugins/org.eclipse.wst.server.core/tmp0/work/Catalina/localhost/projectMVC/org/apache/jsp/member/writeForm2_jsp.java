 ...
 * Generated at: 2024-02-23 02:59:29 UTC
...
public final class writeForm2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			<th>아이디</th>\r\n");
      out.write("			<td>\r\n");
      out.write("				<input type=\"text\" name=\"id\" id=\"id\" size=\"25\" placeholder=\"아이디 입력\"/>\r\n");
      ...
      out.write("			<th>성별</th>\r\n");
      out.write("			<td>\r\n");
      out.write("				<input type=\"radio\" name=\"gender\" id=\"mail\" value=\"0\" checked/>\r\n");
      ...
      out.write("			<th>주소</th>\r\n");
      out.write("			<td>\r\n");
      out.write("				<input type=\"text\" name=\"zipcode\" id=\"zipcode\" placeholder=\"우편번호\" readonly>\r\n");
      ...
      out.write("				<input type=\"button\" value=\"회원가입\" id=\"writeBtn\">\r\n");
      ...
      out.write("			if($('#id').val() == '')\r\n");
      out.write("				$('#idDiv').html('아이디를 입력하시오');\r\n");
      out.write("			else\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					type: 'post',\r\n");
      out.write("					url: '/projectMVC/member/checkId2.do',\r\n");
      out.write("					data: 'id=' + $('#id').val(), //서버로 보낼 데이터: 변수=값\r\n");
      out.write("					dataType: 'text', //서버로부터 오는 데이터의 타입(자료형) 'exist' or 'non_exist'\r\n");
      out.write("					success: function(data){\r\n");
      out.write("						//alert(data.trim());\r\n");
      out.write("						\r\n");
      out.write("						if(data.trim() == 'exist')\r\n");
      out.write("							$('#idDiv').html('사용불가능').css('color', 'red');\r\n");
      out.write("						else if(data.trim() == 'non_exist') {\r\n");
      out.write("							$('#idDiv').html('사용 가능').css('color', 'blue');\r\n");
      out.write("							$('#check').val($('#id').val());\r\n");
      out.write("						}\r\n");
      out.write("					},\r\n");
